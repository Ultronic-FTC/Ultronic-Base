...
public class Mecanum extends Drivetrain {
    ...
    public Mecanum(HardwareMap hardwareMap, MecanumConstants mecanumConstants) {
        ...
        rightRear = (DcMotorEx) hardwareMap.get(DcMotorEx.class, mecanumConstants.rightRearMotorName);
        rightFront = (DcMotorEx) hardwareMap.get(DcMotorEx.class, mecanumConstants.rightFrontMotorName);
